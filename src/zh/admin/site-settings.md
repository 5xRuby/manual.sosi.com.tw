...
![錄影畫質與解析度設定](/images/screenshots/zh/features/recording-quality.jpg)

**Guacamole 解析度**決定錄影轉檔輸出的畫面尺寸。可切換兩種填法：
...
![裝置列表每頁筆數設定](/images/screenshots/zh/features/devices-per-page.jpg)

留空或填 0 會使用系統預設值（表格 50 筆、卡片 12 筆）。排版本身由角色決定，詳見[裝置列表](/zh/admin/devices/)。
