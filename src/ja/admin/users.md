...
> **管理者に昇格する前に個別のデバイス許可を解除してください：** 一般ユーザーを管理者ロールに変更する場合、そのアカウントに個別の[接続許可](/ja/admin/connection-auth/)が残っていると、システムが変更をブロックし、先に解除するよう求めます。管理者はもともとすべてのデバイスにアクセスできるため、古い許可を残しておくと、後日一般ユーザーに戻した際に長期間メンテナンスされていない設定がそのまま適用されてしまいます。
