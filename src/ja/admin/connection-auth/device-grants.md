...
| **デバイス名** | 対象デバイスを選択します。ドロップダウンは検索に対応し、各選択肢は「名称 (IP:port)」形式で表示されるため、名称・IP・port のいずれでも（大文字小文字を区別せず）絞り込めます。デバイス数が多くても一覧をスクロールする必要はありません |


![検索できるデバイスのドロップダウン](/images/screenshots/ja/features/device-select.jpg)
